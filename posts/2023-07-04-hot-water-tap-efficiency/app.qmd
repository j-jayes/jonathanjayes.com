...
You can adjust any of these assumptions in the inputs below to see how they affect the result. The entire article is dynamic, so adjust the inputs and read it again from the top to see what the payoff period is in your case!^[If for instance, you drink 25 cups of tea per day, the Quooker will pay for itself in 12.5 years.]
