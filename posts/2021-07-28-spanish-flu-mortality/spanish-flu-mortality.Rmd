...
setwd(here::here("posts/2021-07-28-spanish-flu-mortality"))
library(tidyverse)
library(tidymodels)
library(tidytext)
library(lubridate)
...
```{r viridis-deaths,  fig.width = 8, fig.height=6, fig.cap="Heatmap of deaths per week"}
#| column: page
jpeg(
...
```{r town-density,  fig.width = 8, fig.height=6, fig.cap="Ridge plot of number of deaths in district by date"}
#| column: page
jpeg(
...
```{r cradock-paarl-causes,  fig.width = 8, fig.height=6, fig.cap="Density plot comparing causes of death during the pandemic in Cradock and Paarl"}
#| column: page
jpeg(
...
```{r seasonality,  fig.width = 8, fig.height=6, fig.cap="Mortality by week across districts - excluding 1918"}
#| column: page
jpeg(
...
```{r mean-mortality-by-district-tab, }
df_acuasoto <- df %>%
...
```{r excess-mortality-method-2,  fig.width = 8, fig.height=6, fig.cap="Excess mortality based on methodology by @AcuaSoto2011InfluenzaAP"}
#| column: page
jpeg(
...
```{r, linear-trend,  fig.width = 8, fig.height=6, fig.cap="Linear trend for predicted and excess mortality"}
#| column: page
library(ggrepel)
...
```{r, regression-methods,  fig.width = 8, fig.height=6, fig.cap="Excess mortality based on regression methods"}
#| column: page
df_reg <- df %>%
...
```{r, phillips-comparison-fig,  fig.width = 8, fig.height=6, fig.cap="Comparison of excess mortality estimates, respiratory deaths and government estimates"}
#| column: page
...
```{r, infant-mortality,  fig.width = 8, fig.height=6, fig.cap="Infant mortality per 1000 children"}
#| column: page
# jpeg(
#     filename="images_bloom/12_13.jpeg",
#     width=6,
...
```{r, infant-mort-scatter,  fig.width = 8, fig.height=6, fig.cap="Scatterplot and linear fit of infant and pandemic mortality by district"}
#| column: page
...
```{r child-mortality,  fig.width = 8, fig.height=6, fig.cap="Child mortality per 1000 children"}
#| column: page
...
```{r, child-mort-scatter,  fig.width = 8, fig.height=6, fig.cap="Scatterplot and linear fit of child and pandemic mortality by district"}
#| column: page
# jpeg(
...
```{r, pneumonia-influenza-mort,  fig.width = 8, fig.height=6, fig.cap="Scatterplot and linear fit of pneumonia mortality and pandemic mortality by district"}
#| column: page
...
```{r, literacy-fig,  fig.width = 8, fig.height=6, fig.cap="Share of informants who sign"}
#| column: page
# jpeg(
...
```{r, literacy-scatter,  fig.width = 8, fig.height=6, fig.cap="Scatter plot and linear fit of literacy proxy and pandemic mortality by district"}
#| column: page
...
```{r, birth-places,  fig.width = 8, fig.height=6, fig.cap="Birth places of district residents"}
#| column: page
...
```{r, birth-place-corr,  fig.width = 8, fig.height=6, fig.cap="Scatter plot and linear fit of residents born outside of the Cape Province and pandemic mortality by district"}
#| column: page
# jpeg(
...
```{r, tuning-fig,  fig.width = 8, fig.height=6, fig.cap="Model metrics for classification model and hyperparamter values", code_folding=F}
#| column: page
# jpeg(
...
```{r, conf-mat-fig,  fig.width = 8, fig.height=6, fig.cap="Confusion matrix for classification model", code_folding=F}
#| column: page
# jpeg(
...
```{r, words-fig,  fig.width = 8, fig.height=6, fig.cap="Determinants of classification model", code_folding=F}
#| column: page
# jpeg(
...
```{r, ethnicity-race-classification,  fig.width = 8, fig.height=6, fig.cap="Output of classification model"}
#| column: page
# jpeg(
